...
{
    /// <summary>
    /// Bootlegged tunnelingvinigette for damage/heal flashes. 
    ...
    {
        private static Color reddish = new Color(.5f, 0, 0);
        private static Color greenish = new Color(0, .7f, 0);

        private static float timeDelay = .3f;
        ...
        public static readonly VignetteParameters DamageEffect = new VignetteParameters
        {
            ...
            easeInTimeLock = false,
            easeOutDelayTime = 0f,
            vignetteColor = reddish,
            vignetteColorBlend = reddish,
            apertureVerticalPosition = 0f
        };

        public static readonly VignetteParameters healEffect = new VignetteParameters
        {
            apertureSize = 0.6f,
            featheringEffect = 0.2f,
            easeInTime = 0.2f,
            ...
            vignetteColor = greenish,
            vignetteColorBlend = greenish,
            apertureVerticalPosition = 0f
        };
        ...
        [SerializeField]
        VignetteParameters m_DamageParameters = DamageEffect;

        [SerializeField]
        VignetteParameters m_HealParameters = healEffect;

        [SerializeField]
        VignetteParameters m_noParameters = noEffect;
        ...
        public VignetteParameters noParameters
        {
            get => m_noParameters;
            set => m_noParameters = value;
        }


        public VignetteParameters DamageParameters
        {
            get => m_DamageParameters;
            set => m_DamageParameters = value;
        }

        public VignetteParameters HealParameters
        {
            get => m_HealParameters;
            set => m_HealParameters = value;
        }
        ...
        protected virtual void Update()
        {
            ...
            if (timer < timeDelay && shotted)
            {
                timer += Time.deltaTime;
                m_CurrentParameters.CopyFrom(DamageParameters);
            }
            else
            {
                shotted = false;
        ...
        public void DamageFlasher()
        {
            BeginTunnelingVignette();
            shotted = true;
            //print("starting Damageflasher\n");
            //UpdateTunnelingVignette(DamageEffect);
            // float timer = 0.0f;
        ...
        public void HealFlasher()
        {
            UpdateTunnelingVignette(healEffect);
            UpdateTunnelingVignette(noEffect);
